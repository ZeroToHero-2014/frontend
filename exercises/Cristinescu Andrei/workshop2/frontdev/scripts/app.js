...
function showList() {
    var myTable = '<div id="myTable"><table border="1" class="table table-hover" ><tr><th>First Name</th><th>Last Name</th><th>Phone</th><th>Salary</th></tr>';
    ...
    s = document.getElementsByClassName("SumB");
