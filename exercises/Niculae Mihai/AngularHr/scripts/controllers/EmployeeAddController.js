hrApp.controller('EmployeeAddController', ['$scope', '$http', function
    ($scope, $http) {
    $scope.employee = {};
    $http({url: 'http://demo.teamnet.ro:8282/datamodel/departments/findAll',
        method: 'GET'}).
    ...
    $http({url: 'http://demo.teamnet.ro:8282/datamodel/jobs/findAll', method:
        'GET'}).
        success(function (data) {
            $scope.jobs = data;
        });
    ...
    $scope.create = function (addEmployee) {
        ...
        $http({url: 'http://demo.teamnet.ro:8282/datamodel/employees/create',
            ...
            success(function (data) {
                $scope.employee = data;
                $scope.eroare = false;
            }).error(function(){ $scope.eroare = true;});
    }
}]);